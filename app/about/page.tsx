    ...
    return (
      <div className="max-w-2xl mx-auto px-6 py-7">
        ...
        <div className="flex items-center gap-3 mb-6">
          <div className="w-14 h-14 rounded-full bg-blog-accent-light flex items-center justify-center text-blog-accent font-sans font-medium text-xl">
            SV
          </div>
        ...
        <div className="space-y-4">
          <p className="text-base leading-[1.8] text-blog-text-muted">
